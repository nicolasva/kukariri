...
ActiveRecord::Schema.define(:version => 20120829220407) do
  ...
  add_index "pictures", ["type_id"], :name => "index_items_on_types_bis", :unique => true
  ...
  add_index "states", ["country_id"], :name => "index_countries_on_states", :unique => true
